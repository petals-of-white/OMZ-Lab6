...
createShaderProgram = do
  ...
  vertexShader <- compileShader GL_VERTEX_SHADER "shaders_old/vert.glsl"
  fragmentShader <- compileShader GL_FRAGMENT_SHADER "shaders_old/frag.glsl"
